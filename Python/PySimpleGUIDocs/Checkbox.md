...
Set to True if you want this checkbox initially checked
...
color of background of the box that has the check mark in it. The checkmark is the same color as the text
...
Turns on the element specific events. Checkbox events happen when an item changes
...
if True checks the checkbox, False clears it
...
color of the text. Note this also changes the color of the checkmark
